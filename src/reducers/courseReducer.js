import { SET_TOKEN_LOGIN, SET_CHOOSE_FRIENDS_DATA ,SET_CHOOSE_FRIENDS, ADD_COURSE, EDIT_COURSE, DELETE_COURSE, TOGGLE_FAVORITE, SEARCH_COURSES, SET_COURSES, EDIT_EXERCISE, EXERCISE_STATUS, SET_CHOOSE_EMOJI, SET_CHOOSE_ADDRESS, ACCESS_TOKEN_LOGIN } from '../constants/CourseTypes';
import { v4 as uuidv4 } from 'uuid';


export const accessTokenLoginReducer = (state = [], action)=>{
  switch (action.type) {
